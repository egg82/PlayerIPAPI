...
public class ConfigLoader {
	...
	public static Configuration getConfig(String resourcePath, String configFileName) {
		...
		try {
			root = loader.load(ConfigurationOptions.defaults().setHeader("Comments are gone because update :(. Click here for new config + comments: https://www.spigotmc.org/resources/player-ip-api.57678/"));
		} catch (Exception ex) {
