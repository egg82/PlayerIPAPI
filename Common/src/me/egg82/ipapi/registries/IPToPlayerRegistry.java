...
public class IPToPlayerRegistry extends ExpiringRegistry<String, Set<UUIDData>> {
    ...
    public IPToPlayerRegistry() {
        super(new String[0], new Set[0], TimeUtil.getTime(ServiceLocator.getService(Configuration.class).getNode("cacheTime").getString("1minute")), TimeUnit.MILLISECONDS, ExpirationPolicy.ACCESSED);
    }
