...
public class PlayerIPAPI extends BasePlugin {
    ...
    public static IPLookupAPI getAPI() {
        return IPLookupAPI.getInstance();
    }
    ...
    public void onEnable() {
        ...
        numCommands = ServiceLocator.getService(CommandProcessor.class).addHandlersFromPackage("me.egg82.ipapi.commands",
            PluginReflectUtil.getCommandMapFromPackage("me.egg82.ipapi.commands", false, null, "Command"), false);
