...
public class UUIDData {
	...
	public int hashCode() {
		// I am well aware that this likely violates the hashCode agreement, but is needed for fast (and accurate) imports
	...
	public boolean equals(Object other) {
		...
		// I am well aware that this likely violates the equals agreement, but is needed for fast (and accurate) imports
